...
CREATE TABLE IF NOT EXISTS "StockItems" (
    ...
    "BuyPrice" numeric(18,2) NOT NULL DEFAULT 0,
    "SellPrice" numeric(18,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ""StockItems"" (
    ...
    ""BuyPrice"" TEXT NOT NULL DEFAULT '0',
...
");
            ...
            if (!await SqliteColumnExistsAsync(db, "StockItems", "BuyPrice"))
            {
                await db.Database.ExecuteSqlRawAsync(
                    @"ALTER TABLE ""StockItems"" ADD COLUMN ""BuyPrice"" TEXT NOT NULL DEFAULT '0';");
            }
            if (!await SqliteColumnExistsAsync(db, "StockItems", "SellPrice"))
            {
                await db.Database.ExecuteSqlRawAsync(
                    @"ALTER TABLE ""StockItems"" ADD COLUMN ""SellPrice"" TEXT NOT NULL DEFAULT '0';");
            }
...
");
            if (!await SqliteColumnExistsAsync(db, "StockMovements", "UnitCost"))
            {
                await db.Database.ExecuteSqlRawAsync(
                    @"ALTER TABLE ""StockMovements"" ADD COLUMN ""UnitCost"" TEXT NULL;");
            }
            if (!await SqliteColumnExistsAsync(db, "StockMovements", "CostAmount"))
            {
                await db.Database.ExecuteSqlRawAsync(
                    @"ALTER TABLE ""StockMovements"" ADD COLUMN ""CostAmount"" TEXT NULL;");
            }
