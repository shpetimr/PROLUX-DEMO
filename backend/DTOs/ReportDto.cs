namespace backend.DTOs
{
    public class FinancialReportDto
    {
        ...
        public decimal TotalFiscalReceipts { get; set; }
        public int FiscalReceiptsCount { get; set; }
        ...
        public decimal TotalFiscalReceiptStockCost { get; set; }
        public int FiscalReceiptStockCostCount { get; set; }
    ...
    public class DashboardStatsDto
    {
        ...
        public decimal CurrentMonthFiscalReceipts { get; set; }
        public int CurrentMonthFiscalReceiptsCount { get; set; }
        public decimal CurrentMonthFiscalReceiptStockCost { get; set; }
        public int CurrentMonthFiscalReceiptStockCostCount { get; set; }
        ...
        public decimal YearToDateFiscalReceipts { get; set; }
        public int YearToDateFiscalReceiptsCount { get; set; }
        public decimal YearToDateFiscalReceiptStockCost { get; set; }
        public int YearToDateFiscalReceiptStockCostCount { get; set; }
        ...
        public decimal TotalFiscalReceipts { get; set; }
        public int TotalFiscalReceiptsCount { get; set; }
        public decimal TotalFiscalReceiptStockCost { get; set; }
        public int TotalFiscalReceiptStockCostCount { get; set; }
        public int WorkerTasksTotal { get; set; }
        public int WorkerTasksWaiting { get; set; }
        public int WorkerTasksInProcess { get; set; }
        public int WorkerTasksCompleted { get; set; }
